...
const navigationItems = [
  ...
  },
  {
    ...
    items: [
      {
        name: "Daily Report",
        url: "/shop/reports/daily",
      },
      {
        name: "Weekly Report",
        url: "/shop/reports/weekly",
      },
    ],
  },
  {
      ...
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem className="pt-3">
            ...
            >
              <Link to="/shop/dashboard" className="space-x-3">
                <img
                  src={navibitesLogo}
                  alt="NaviBites Logo"
                ...
                />
                <span className="text-lg font-semibold">NaviBites Shop</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
            ...
            <Collapsible open={isOpen} onOpenChange={setIsOpen}>
              ...
              <CollapsibleContent className="CollapsibleContent">
                <SidebarMenuButton asChild className="cursor-pointer pl-8">
                  <Link to="/shop/settings" className="flex items-center gap-2">
